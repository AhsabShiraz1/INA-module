...
export default function ParsaLevel({ setNotification }: LevelProps) {
  ...
  return (
    <>
      ...
      />
      <Model
        url="/assets_2/ina_tank_v32_m_(1).glb"
        position={[1.5, 1.8, -1]}
        scale={0.6}
        rotation={[0, 0, 0]}
      />
      <Model
        url="/assets_2/right_wheel.glb"
        position={[1.5, 1.5, -1]}
        scale={0.6}
        rotation={[0, 1, 0]}
      />
      <Model
        url="/assets_2/left_wheel.glb"
        position={[3, 1.5, -1]}
        scale={0.6}
        rotation={[0, 1, 0]}
      />
      <Model
        url="/assets_2/_1_uploads_files_3830026_Caterpillar_Track_Low-Poly.glb"
        position={[3, 1.8, -1]}
        scale={0.6}
        rotation={[0, 0, 0]}
      />
      <Model
        url="/assets_2/_1_uploads_files_3830026_Caterpillar_Track_Low-Poly_2.glb"
        position={[5, 1.8, -2]}
        scale={0.6}
        rotation={[0, 0, 0]}
      />
