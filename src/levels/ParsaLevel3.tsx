...
export default function ParsaLevel3({ setNotification }: LevelProps) {
  ...
  return (
    <>
        ...
        <Root>
          ...
          >
            <Container flexDirection="column" alignItems="flex-start">
              ...
              <Text fontSize={10} fontWeight="medium">
                * We will move to the open pit mine after putting on the PPE kit
              </Text>
              <Text fontSize={10} fontWeight="medium">
                * The value chain will be demonstrated step by step
              </Text>
              <Text fontSize={10} fontWeight="medium">
                * Click 'Next' to proceed to the open pit mine.
              </Text>
            </Container>
          </Container>
        </Root>
      ...
      />
      <VideoPlayer scale={[0.5, 0.5, 0.5]} src="/assets_2/fuel_system_sop_mountain.mp4" position={[-8, 1.5, -6]} rotation={[0, Math.PI / 4, 0]}></VideoPlayer>
    </>
  )
